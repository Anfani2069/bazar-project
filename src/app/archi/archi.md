...
Exemple
features/ └─ employee-management/ ├─ components/ ├─ services/ ├─ store/ ├─ models/ ├─ facade/ └─ tests/
...
5. Règles de dépendances (obligatoires)
   ...
   Si une feature dépend d’une autre feature : ➡️ extraire la dépendance dans shared
   ou
...
6. Structure interne d’une feature
   ...
   employee-list/ ├─ avatar/ ├─ actions/ └─ overview/
